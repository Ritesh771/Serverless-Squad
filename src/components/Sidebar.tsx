...
const roleNavigation: Record<string, NavItem[]> = {
  ...
  onboard_manager: [
    { title: 'Dashboard', href: '/onboard-manager/dashboard', icon: LayoutDashboard },
    { title: 'Vendor Queue', href: '/onboard-manager/vendor-queue', icon: Users },
    { title: 'Approved Vendors', href: '/onboard-manager/approved-vendors', icon: CheckCircle },
  ],
  ops_manager: [
    { title: 'Dashboard', href: '/ops-manager/dashboard', icon: LayoutDashboard },
    { title: 'Bookings Monitor', href: '/ops-manager/bookings-monitor', icon: MapPin },
    { title: 'Signature Vault', href: '/ops-manager/signature-vault', icon: FileSignature },
    { title: 'Manual Payments', href: '/ops-manager/manual-payments', icon: DollarSign },
    { title: 'Analytics', href: '/ops-manager/analytics', icon: TrendingUp },
  ],
  super_admin: [
    ...
    { title: 'Ethics & AI Flags', href: '/super-admin/ethics', icon: AlertTriangle },
